...
public abstract class NodeView<T> : Node, INodeView where T : PlayableNode
{
    ...
    protected NodeView(T node, List<FieldInfo> nodeInputFieldInfos, NodeGraphView graphView)
    {
        ...
        AddInputPort(nodeInputFieldInfos);
    }
    ...
    protected void AddInputPort(List<FieldInfo> fieldInfos)
    {
        for (int i = 0; i < fieldInfos.Count; i++)
        {
            ...
            inputPort.portName = fieldInfo.Name;
    ...
    public virtual VisualElement GetNodeInspector()
    {
...
public interface INodeView
{
    ...
    VisualElement GetNodeInspector();
